...
/**
 * Copied from react-native-sound@0.11.2 with resolveAssetSource compatibility
 * for React Native 0.80 (Metro now exposes the function as a default export).
 */
...
if (typeof resolveAssetSource !== 'function') {
  throw new Error('resolveAssetSource export shape has changed');
}
