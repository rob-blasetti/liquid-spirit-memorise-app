...
export const quoteMap = {
    ...
    references: [
        {
            ...
            examples: [
                ...
                'From the back of the classroom, Ayumi was not able to hear the teacher well, so she leaned forward and turned her head to listen to him. Ayumi inclined her ear towards the teacher in order to hear him better.'
            ],
        },
        {
            word: 'True',
            examples: [
                ...
                'Odam always did what he promised. His words always matched his deeds. Odam was true to his word.'
            ],
        },
        {
            word: 'Incomparable',
  ...
  '6-2': {
    text: 'O ye beloved of the Lord! Commit not that which defileth the limpid stream of love or destroyeth the sweet fragrance of friendship.',
        references: [
        {
            word: 'Commit',
            examples: [
        ...
        },
        {
            word: 'Defile',
            examples: [
                'The garden had once been beautiful, but some of the people who visited it left garbage and litter when they departed. The visitors defiled the garden with the garbage they left.',
        ...
        },
        {
            word: 'Limpid',
            examples: [
                'The water in the pond was perfectly clear, and it was possible for Tibor to see many fish swimming along its bottom. Tibor could see to the very bottom of the limpid pond.',
  ...
  '6-3': {
    text: '. . . strive ye with all your might to create, through the power of the Word of God, genuine love, spiritual communion and durable bonds among individuals.',
    references: [
        {
            word: 'Genuine',
            examples: [
  ...
  '7-2': {
    ...
    references: [
        ...
        },
        {
            word: 'Sloth',
            examples: [
                'We avoid laziness and sloth when we are active, using our minds and our energies at all times to serve others.',
                'Iman does not give in to laziness and sloth, so he studies hard every day to become a mechanic. He wants to be a useful member of the community.'
            ],
        },
        {
            word: 'Profit',
  ...
  '7-3': {
    text: 'It is incumbent upon each one of you to engage in some occupation—such as a craft, a trade or the like. We have exalted your engagement in such work to the rank of worship of the one true God.',
    references: [
        {
            word: 'Incumbent',
            examples: [
                'Parents must be responsible for making sure that their children receive an education. It is incumbent upon parents to see to their children’s education.',
